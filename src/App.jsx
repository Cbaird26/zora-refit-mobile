...
export const TOP_LEVEL_DEVICES = [
  ...
  { id: "autopilot", label: "Autopilot", color: P.gold, comp: DiscoveryTab, discoveryMode: "AUTOPILOT", discovery: true },
...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: P.void, color: P.text, fontFamily: FONT, position: "relative", overflowX: "hidden" }}>
      <div style={{ position: "relative", zIndex: 1, padding: "max(18px, env(safe-area-inset-top)) max(14px, env(safe-area-inset-right)) max(24px, env(safe-area-inset-bottom)) max(14px, env(safe-area-inset-left))" }}>
        <div style={{ marginBottom: 18 }}>
          <div style={{ display: "flex", alignItems: isMobile ? "stretch" : "baseline", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
            <div>
              <h1 style={{ margin: 0, fontSize: isMobile ? 24 : 22, fontWeight: 700, color: "#fff", fontFamily: "'Georgia', serif" }}>Zora Refit</h1>
              <span style={{ display: "inline-block", marginTop: 4, fontSize: 11, color: P.glow, letterSpacing: "0.1em", textTransform: "uppercase", fontWeight: 600 }}>Refit mobile surface · native shell anchored to the Phase V bridge artifact</span>
            </div>
          </div>
        ...
        <div style={{ marginTop: 16, textAlign: "center" }}>
          <div style={{ fontSize: 11, color: P.faint, letterSpacing: "0.04em", lineHeight: 1.7 }}>
            {"GROUNDING: Probability tilt \u00B7 Yukawa fold preview \u00B7 GKSL branch selection \u00B7 Decision / Intent / Navigation / Autopilot / Research bridge modes"}
          </div>
